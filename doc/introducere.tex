...
calculator virtual format din CPU, ierarhia de cache si memoria principala.
...
\paragraph{Predictie.}
Pentru un PC dat, fiecare tabel $i$ calculeaza un index prin
$\mathit{idx}_i = (PC \oplus \mathit{GHR}[0:L[i]]) \bmod \mathit{tableSize}$.
