...
\textbf{SimpleScalar} este un set de instrumente \cite{austin1997user} care modeleaza un sistem de
...
de ramificatii \cite{seznec2004gehl} modern care foloseste mai multe tabele de predictie, fiecare
...
\textbf{Wang~'97 hybrid value predictor} este un predictor de valori \cite{wang1997highly} propus de
